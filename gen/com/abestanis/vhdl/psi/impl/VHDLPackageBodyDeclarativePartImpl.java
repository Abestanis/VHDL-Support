...
public class VHDLPackageBodyDeclarativePartImpl extends ASTWrapperPsiElement implements VHDLPackageBodyDeclarativePart {
  ...
  @Override
  @NotNull
  public List<VHDLPackageBodyDeclarativeItem> getPackageBodyDeclarativeItemList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, VHDLPackageBodyDeclarativeItem.class);
  }
